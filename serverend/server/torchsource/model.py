...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, zero_init_residual=False,
        ...
        self.pool = nn.MaxPool2d(2)
        self.up1 = nn.ConvTranspose2d(256, 128, kernel_size=4, padding=1, stride=2, bias=False)
        self.up2 = nn.ConvTranspose2d(128 + 128, 64, kernel_size=4, padding=1, stride=2, bias=False)
        self.up3 = nn.ConvTranspose2d(64 + 64, 32, kernel_size=4, padding=1, stride=2, bias=False)
        self.up4 = nn.ConvTranspose2d(64 + 64, 32, kernel_size=4, padding=1, stride=2, bias=False)
        self.last_layer = nn.Conv2d(32, 1, 1)
...
if __name__ == '__main__':
    head = MaskHead(512)
    input = torch.rand(1, 3, 128, 128, dtype=torch.float32)
    model = resnet18()
